...
public class MovingObject : MonoBehaviour {
    ...
    //Move takes parameters for x direction, y direction and a RaycastHit to check collision.
    protected bool Move(int xDir, int yDir, int zDir, out RaycastHit hit)
    {
        ...
        //hit = Physics.Linecast(start, end, out hit);
        if (!Physics.Linecast(start, end, out hit))
        {
            ...
            {
                //If nothing was hit, start SmoothMovement co-routine passing in the Vector3 end as destination
    ...
    protected virtual void AttemptMove<T>(int xDir, int yDir, int zDir)
        where T : Component
    {
        ...
        bool canMove = Move(xDir, yDir, zDir, out hit);
